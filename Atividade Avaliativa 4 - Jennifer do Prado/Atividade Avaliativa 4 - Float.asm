...
main:  
    Estrutura:
        ...
        li $v0, 2			                #usando o codigo SysCall para escrever float
        mov.s $f12, $f5 	                #valor do somatorio para a impressao
    ...
    leitura:
        l.s $f5, zero        #carrega em $f5 o float 0, vai guardar o somatorio dos elementos da diagonal secundaria		
